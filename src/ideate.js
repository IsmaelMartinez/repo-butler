...
function appendGovernanceContext(parts, findings) {
  ...
  for (const f of findings) {
    if (f.type === 'standards-gap') {
      ...
      const secret = f.secretScanning ? ` + ${f.secretScanning} secret` : '';
