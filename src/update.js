...
export function buildUpdatePrompt(currentRoadmap, snapshot, assessment, projectContext, now = new Date()) {
  ...
  return wrapPrompt({
    ...
    outroLines: [
      ...
      '- VERBATIM RULE: every existing paragraph must appear in the output with IDENTICAL wording, in the SAME position. Do not rephrase, reword, move, reorder, or summarise any existing text. Copy it character-for-character. This is the most important rule.',
